                    ...
                    <div class="col-md-12 col-12 mt-6">
                      ...
                      <div class="card">
                        ...
                        <div class="card-header bg-white  py-4">
                          <h4 class="mb-0">Pengajuan Selesai</h4>
                        </div>
                              ...
                              <tr>
                                ...
                                <td  class="align-middle">
                                  <?php if($data->pelayanan == "Daring"){ ?>
                                      <span class="badge bg-warning">Daring</span>
                                  <?php }else{ ?>
                                ...
                                <td  class="align-middle">
                                <?php if($data->status == 4){ ?>
                                  <a href="<?= base_url('pengajuan/detail/'.$data->id) ?>" class="btn btn-primary text-white"><i class="bi bi-file-earmark-check-fill"></i> Detail Disposisi</a>                                  
                                  <?php }?>
                                </td>
                              </tr>
                              <?php } ?>
