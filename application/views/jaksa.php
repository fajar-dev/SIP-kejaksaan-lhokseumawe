                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                  <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal-2" class="btn btn-white">Tambah Jaksa</a>
                                </div>
                            </div>
                        </div>
                    </div>
                              ...
                              <tr>
                                ...
                                <td  class="align-middle">
                                  <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#edit_jaksa<?= $data->id?>" class="btn btn-warning text-white">Edit</a>
                                    <a href="<?= base_url('main/hapus_jaksa/'.$data->id) ?>" onclick="confirm('Anda Yakin Ingin Menghapus Data?');" class="btn btn-danger">Hapus</a>
                                  </div>
                                </td>
                                <!-- Modal -->
