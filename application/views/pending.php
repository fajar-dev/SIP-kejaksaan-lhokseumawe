                            ...
                            <tbody>
                              ...
                              <tr>
                                <td  class="align-middle">
                                  <a href=""><?php echo htmlentities($data->nama, ENT_QUOTES, 'UTF-8');?> <i class="bi bi-info-circle"></i></a>
                                </td>
                                ...
                                <td  class="align-middle">
                                  <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#edit_Admin<?= $data->id?>" class="btn btn-success text-white"><i class="bi bi-check-lg"></i> Disposisi</a>
